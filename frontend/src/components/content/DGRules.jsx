function DGRules() {
    return (
        <div>
            <h1>Rules</h1>
            <p>    Pick 5 MPO players each Elite Series(+) and Major tournament.  </p>
            <p>    Picks must be submitted by midnight before the first round of the tournament  </p>
            ...
            <p>    <strong>(Player's total score in throws) - (Winner's total score in throws)</strong></p>
            <p>    Thus, lower scores are better.  </p>
            ...
            <p>    Go to the "Picks" tab to make your selections for each tournament (make sure to submit)</p>
            <p>    The list of players you selected will be shown next to the selections</p>
            <p>    The "Tournaments" list will show the scores for each player after the event</p>
            <p>    The "Standings" tab will have the overall scores of league participants</p>
            <p>    Any questions? Email or Text me!</p>
        </div>
    );
}

export default DGRules;